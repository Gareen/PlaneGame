...
public class Frame103 extends MyFrame {
	
	Image bg = GameUtil.getImage("images/bg2.png");
	Plane p = new Plane("images/zhainan.png",400,444);	
	...
	public void paint(Graphics g) {
		...
		if(!p.isLive()) {
			...
			case 20:
				...
				break;				
			default:
				printInfo(g,"请凭借Key码 CDErssyskmWEKDJ",50,350,100,Color.red);
	...
	public void launchFrame() {
		...
		for(int i = 0;i < 25;i++) {
			if(i < 8) {
				Bullet b = new Bullet("images/xin.png",800,700);
				bulletList.add(b);
			}
			if(i <17 && i >= 8) {
				Bullet b = new Bullet("images/xin1.png",50,50);
				bulletList.add(b);
			}
			if(i <25 && i >= 17) {
				Bullet b = new Bullet("images/xin1.png",500,800);
				bulletList.add(b);
			}
		}
		startTime = new Date();
